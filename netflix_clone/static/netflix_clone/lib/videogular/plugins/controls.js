	...
	.directive(
		...
		["$timeout", "VG_STATES", "VG_EVENTS", function($timeout, VG_STATES, VG_EVENTS){
			return {
				...
				require: "^videogular",
				transclude: true,
				templateUrl: "/static/netflix_clone/lib/videogular/plugins/controls/controls.html",
				scope: {
					autoHide: "=vgAutohide",
	...
	.directive(
		...
		["VG_STATES", "VG_EVENTS", function(VG_STATES, VG_EVENTS) {
			return {
				restrict: "E",
				require: "^videogular",
				templateUrl: "/static/netflix_clone/lib/videogular/plugins/controls/play-pause-button.html",
				scope: {
					vgPlayIcon: "=",
					vgPauseIcon: "="
				},
	...
	.directive(
		...
		["VG_EVENTS", "VG_UTILS", function(VG_EVENTS, VG_UTILS) {
			return {
				restrict: "E",
				require: "^videogular",
				templateUrl: "/static/netflix_clone/lib/videogular/plugins/controls/volume-bar.html",
				link: function(scope, elem, attr, API) {
	...
	.directive(
		...
		["VG_EVENTS", function(VG_EVENTS) {
			return {
				...
				templateUrl: "/static/netflix_clone/lib/videogular/plugins/controls/mute-button.html",
				link: function(scope, elem, attr, API) {
	...
	.directive(
		...
		["$window", "VG_EVENTS", function($window, VG_EVENTS){
			return {
				...
				templateUrl: "/static/netflix_clone/lib/videogular/plugins/controls/full-screen-button.html",
				link: function(scope, elem, attr, API) {
